...
<header class="w3-container w3-cyan w3-center " style="padding:128px 16px; background-image: url('img/ccc.jpg')  !important">
    <div style="background-color: black; width:30%; border: 2px solid white" class="container-fluid">
...
<div class="w3-container w3-black w3-center w3-opacity w3-padding-64">
    <h1 class="w3-margin w3-xlarge">"Successful and unsuccessful people do not vary greatly in their abilities. They vary in there desires to reach there potential" -John Maxwell</h1>
</div>
